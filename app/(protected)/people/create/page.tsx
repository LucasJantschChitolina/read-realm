                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        <div className="grid grid-cols-3 gap-2">
                            <div className="flex flex-col gap-2">
                                ...
                                <Input name="email" type="email" role="presentation" autoComplete="off" placeholder="Insira aqui o email" />
                            </div>
                            <div className="flex flex-col gap-2">
                                <Label htmlFor="password">Senha</Label>
                                <Input name="password" type="password" placeholder="Insira aqui a senha" />
                            </div>
                            <div className="flex flex-col gap-2">
                                <Label htmlFor="phone">Telefone</Label>
                                <Input name="phone" type="tel" placeholder="Insira aqui o telefone" />
                            </div>
                        </div>
